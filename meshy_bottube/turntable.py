...
# frames=0 from dividing by zero in the orbit math. Caps are deliberately
# modest: BoTTube's upload target is 720x720, so 360 frames (12s @ 30fps) at
# 1280² is already more than any turntable needs, keeping worst-case PNG disk
# well under a couple GB.
MIN_FRAMES, MAX_FRAMES = 1, 360
MIN_RESOLUTION, MAX_RESOLUTION = 16, 1280
